...
<html lang = "eng">
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/landscape.png" width = "200px" height = "50px"/>
					<p class = "navbar-text pull-right">Food Tech's Attendance</p>
				</div>
			</div>
		</nav>
		...
		<div class = "navbar navbar-fixed-bottom alert-warning">
			<div class = "container-fluid">
				<label class = "pull-left">&copy; Food Intel Tech</label>
			</div>	
		</div>
	</body>
